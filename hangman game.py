...
def play_game(secret_word):
    ...
    print(f'Your word is {len(secret_word)} letters long and you can make maximum 7 incorrect guesses\n')
    ...
    while len(incorrect_guesses) < 7:
        ...
        if guessed_letter in secret_word:
            ...
            if partial_word == secret_word or ask_if_guessed(secret_word) == True:
                ...
                print(f'in {len(correct_guesses)} correct guesses and {len(incorrect_guesses)} incorrect guesses')
                break
        else:
        ...
        if len(incorrect_guesses) == 5 and hint_shown == False:
            print('You have only two more guesses left')
